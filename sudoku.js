"use strict";
//helps catch common coding errors and unsafe actions such as assigning values to undeclared variables.
...
//These variables store string representations of Sudoku puzzles of varying difficulty levels (easy, medium, and hard).
// Each string represents a 9x9 Sudoku board, where numbers represent given cells and hyphens (-) represent empty cells.
...
var SudokuSolver = function (testable) {
  ...
  function allRowsValid(boardArray) {
    //0,9,.... is the starting index of each row.
    return [0, 9, 18, 27, 36, 45, 54, 63, 72].map(function (i)
    //map function will iterate i=0, 9, 18, 27, 36, 45, 54, 63, 72
    {
